...
// Pre: contador y dato son punteros a entero.
// Función wrapper de _visitar pasando como parámetros a clave, dato y contador
...
static bool visitar2(const char* clave, void* dato, void* contador){
...
void prueba_abb_iter_interno(void){

    abb_t* abb = abb_crear(strcmp, NULL);

    print_test("Prueba abb fue creado correctamente", abb);
    ...
    abb_in_order(abb, visitar, &cont);

    print_test("Se ejecuto correctamente", cont == 1);
    
    cont = 0;
    
    abb_in_order(abb, visitar2, &cont);

    print_test("Prueba abb iterador interno se ejecutó correctamente", cont == 3);
    
    abb_destruir(abb);

}

void pruebas_normales(void){
    ...
    abb_guardar(abb, clave7, &valor7);
    abb_guardar(abb, clave9, &valor9);
    print_test("Guardo todos los elementos", true);

    //Borro

    print_test("Borro raiz", abb_borrar(abb, clave6) == &valor6);
    print_test("Borro nodo de dos hijos", abb_borrar(abb, clave8) == &valor8);
    print_test("Borro otro de dos hijos", abb_borrar(abb, clave4) == &valor4);
    print_test("Borro con un hijo", abb_borrar(abb, clave3) == &valor3);
    print_test("Borro otro con un hijo", abb_borrar(abb, clave7) == &valor7);
    print_test("Borro hoja", abb_borrar(abb, clave5) == &valor5);
    print_test("Borro otra hoja", abb_borrar(abb, clave9) == &valor9);
